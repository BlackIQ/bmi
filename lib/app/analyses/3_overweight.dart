      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ParagraphText(
              text:
                  'Katherine Flegal et al., however, found that the mortality rate for individuals who are classified as overweight (BMI 25 to 29.9) may actually be lower than for those with an "ideal" weight (BMI 18.5 to 24.9), noting that many studies show that the lowest mortality rate is at a BMI close to 25.',
            ),
            SizedBox(height: 5),
            ParagraphText(
              text:
            ...
            ParagraphText(
              text:
                  "As much as 71.6% of the United States' adult population aged 20 and over is considered either overweight or obese, and this percentage has increased over the last four decades.",
            ),
          ],
        ),
      ),
